...
--   - Se cambia DATETIME por DATE para el MVP
--   - Se inserta campo ocupacion en tabla usuarios
-- =========================================================================
...
CREATE TABLE usuarios (
    ...
    --             Roles válidos: MASTER, ADMIN, USER.
    ...
    CONSTRAINT chkusuariosrol       CHECK (rol IN ('MASTER', 'ADMIN', 'USER')),
