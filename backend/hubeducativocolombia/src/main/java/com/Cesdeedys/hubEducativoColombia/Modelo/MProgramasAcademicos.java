...
public class MProgramasAcademicos {
    ...
    public MProgramasAcademicos(Integer idprograma, String codigosnies, String nombreprograma, String nivelformacion, Integer totalsemestres, Boolean estaactivo) {
