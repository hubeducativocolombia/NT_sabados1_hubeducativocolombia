...
public class MUsuarios {
    ...
    public MUsuarios(Long idusuario, String nombrecompleto, String correoelectronico, String hashcontrasena, String ocupacion, String rol, Boolean estaactivo, LocalDate fechacreacion, LocalDate fechamodificacion) {
